...
//Count five post
function reverseFivePost(){
    
    var variable=reversePost();
    var newArray= new Array;
    for(var i=0; i<5; i++){
        newArray.push(variable[i]);
    }
...
//Show post information 5 posts
function showFivePost(){
    
    
    var post=reverseFivePost();
    ...
    // EXTRACT VALUE FOR HTML HEADER. 
        ...
        for (var i = countPost()-1; i>=0; i--) {
            ...
            for (var j = 0; j < col.length; j++) {
                ...
                tabCell.innerHTML = post[i][col[j]];
            }
        }
